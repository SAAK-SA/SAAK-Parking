...
import { Plus, Search, Edit2, Trash2, X, Save, Users, UserCheck, UserMinus } from 'lucide-react';
      ...
      {modal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md p-7 animate-scale-in">
            <button onClick={closeModal} className="absolute top-4 end-4 btn-ghost !p-2">
              <X className="w-4 h-4" />
            </button>
            <h3 className="text-brand-navy font-bold text-xl mb-6">
              {modal === 'add'
                ? (ar ? 'إضافة موظف جديد' : 'Add employee')
                : (ar ? 'تعديل بيانات الموظف' : 'Edit employee')}
            </h3>
            ...
            <div className="space-y-4">
              <label className="block">
                ...
                <input
                  className={`field w-full ${errors.id ? 'border-red-400' : ''}`}
                  placeholder="EMP010"
                  dir="ltr"
                  value={form.id}
              ...
              <label className="block">
                ...
                <input
                  className={`field w-full ${errors.nameAr ? 'border-red-400' : ''}`}
              ...
              <label className="block">
                ...
                <input
                  ...
                  placeholder={ar ? 'الإنتاج' : 'Production'}
              ...
              <label className="block">
                ...
                <input
                  ...
                  placeholder="D05"
                  dir="ltr"
                  value={form.assignedSlot}
                  onChange={(e) => setForm({ ...form, assignedSlot: e.target.value })}
                />
